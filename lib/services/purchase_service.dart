...
class PurchaseService {
  ...
  static const _kNoAdsKey = 'sol_no_ads';
  static const _kCoinsKey = 'coinsSolitaire';

  static String _platformId(String logicalId) =>
      Platform.isIOS ? '${logicalId}_sol' : logicalId;

  static String _logicalId(String platformId) =>
      platformId.endsWith('_sol') ? platformId.substring(0, platformId.length - 4) : platformId;
